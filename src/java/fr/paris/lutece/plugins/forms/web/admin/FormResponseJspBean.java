...
import static fr.paris.lutece.plugins.forms.util.FormsConstants.MARK_HELP_MESSAGE;
...
public class FormResponseJspBean extends AbstractJspBean
{
    ...
    public String getStepView( HttpServletRequest request )
    {
        ...
        if ( form.isActive( ) )
        {
            ...
            model.put( MARK_HELP_MESSAGE, I18nService.getLocalizedString( FormsConstants.MESSAGE_VIEW_GROUP_HELP, getLocale( ) ) );
        }
        else
        {
